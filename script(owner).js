...
function reserveDay(clickedDay) {
    if (reservedDays.includes(cells[clickedDay].innerHTML + "." + month + "." + year)) {
       reservedDays.splice(reservedDays.indexOf(cells[clickedDay].innerHTML + "." + month + "." + year),1)
      
    } else{
        reservedDays[reservedDays.length++] = cells[clickedDay].innerHTML + "." + month + "." + year
    }
